...
const editFieldsByType = {
  ...
  [fieldTypes.LOOKUP]: editFields.LookupFields,
};
...
const viewSectionsByType = {
  ...
  [fieldTypes.LOOKUP]: viewSections.LookupSection,
};
...
const FieldAccordion = (props) => {
  ...
  if (fieldData.type === fieldTypes.LOOKUP && isEditMode) {
    contentProps.isRefEntityTypeLocked = isRefEntityTypeLocked;
    contentProps.isRefEntityTypeInUse = isRefEntityTypeInUse;
  }
